...
# ==========================================
# 6. MÓDULOS VISUALES Y NAVEGACIÓN (LUXURY STYLE - RESPONSIVE FIX)
# ==========================================
def aplicar_estilos_luxury():
    ...
    <style>
        ...
        [data-testid="stSidebar"] * { color: #E2E8E4 !important; }
        ...
        .metric-card-lux .val { font-size: 54px; font-family: 'Cinzel', serif; color: #F4E8C1; font-weight: 700; line-height: 1; margin: 15px 0; }
        .metric-card-lux .title { font-size: 16px; font-weight: 600; color: #E2E8E4; display: flex; align-items: center; gap: 10px; }
        .metric-card-lux .badge-pill { background: rgba(46, 125, 96, 0.4); border: 1px solid rgba(212, 175, 55, 0.4); border-radius: 12px; padding: 4px 12px; font-size: 11px; color: #D4AF37; display: inline-block; margin-top: 5px; }
        ...
        .journey-avatar-box { display: flex; align-items: center; gap: 20px; }
        .journey-avatar-circle { width: 75px; height: 75px; border-radius: 50%; background: #2C3E50; display: flex; align-items: center; justify-content: center; color: white; font-size: 36px; flex-shrink: 0; }
        .journey-info h3 { font-family: 'Plus Jakarta Sans', sans-serif !important; font-size: 22px !important; font-weight: 700 !important; color: #1C2B26 !important; margin: 0 0 6px 0 !important; }
        .journey-info p { margin: 2px 0; color: #555555; font-size: 13px; }
        .journey-initial-scan { background: #FFF8EE; border-radius: 12px; padding: 12px 18px; display: flex; align-items: center; gap: 12px; border: 1px solid #F3E5D8; }

        /* TIMELINE */
        .journey-timeline-wrapper { max-width: 750px; margin: 20px auto 0 auto; position: relative; padding-left: 30px; }
        .journey-timeline-line { position: absolute; left: 8px; top: 15px; bottom: 30px; width: 2px; background: #D2DCD6; }
        .journey-timeline-item { position: relative; margin-bottom: 35px; }
        .journey-node-dot { position: absolute; left: -30px; top: 2px; width: 18px; height: 18px; border-radius: 50%; background: #C2D9D0; border: 3px solid #F8F5EE; z-index: 2; }
        .journey-item-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px; flex-wrap: wrap; gap: 5px; }
        .journey-item-title { font-size: 13px; font-weight: 800; text-transform: uppercase; color: #1C2B26; }
        .journey-item-counter { font-size: 12px; color: #666666; font-weight: 600; }
        .journey-progress-track { height: 18px; border-radius: 9px; background: #EAE6DF; width: 100%; overflow: hidden; margin-bottom: 6px; }
        .journey-progress-bar { height: 100%; border-radius: 9px; transition: width 0.5s ease; }
        .journey-item-footer { display: flex; justify-content: space-between; align-items: center; font-size: 12px; color: #555555; font-weight: 500; }

        .mosaico-wrapper { position: relative; width: 100%; border-radius: 16px; overflow: hidden; background: #000000; box-shadow: 0 12px 35px rgba(0,0,0,0.9); display: flex; align-items: center; justify-content: center; }
        .img-kirlian-processed { width: 100%; height: 100%; object-fit: cover; border-radius: 16px; display: block; }
        
        /* RESPONSIVE MÓVIL (MEDIA QUERIES P0) */
        @media (max-width: 768px) {
            /* Restablecer botón menú hamburguesa */
            header { visibility: visible !important; background: transparent !important; }
            [data-testid="stHeader"] { background: rgba(255,255,255,0.9) !important; }
            
            /* Ajuste de contenedor principal */
            .block-container { padding-left: 1rem !important; padding-right: 1rem !important; padding-top: 3rem !important; }
            
            /* Ajuste Tarjetas Historial */
            .journey-card-container { flex-direction: column; text-align: center; padding: 15px; }
            .journey-avatar-box { flex-direction: column; gap: 10px; }
            .journey-initial-scan { margin-top: 15px; width: 100%; justify-content: center; }
            
            /* Ajuste Timeline Módulo Tratamientos (Evita desborde) */
            .timeline-container { padding-left: 10px; }
            .journey-timeline-wrapper { padding-left: 20px; }
            .journey-timeline-line { left: 4px; }
            .journey-node-dot { left: -24px; width: 14px; height: 14px; top: 4px; }
            
            /* Ajuste Métricas */
            .metric-card-lux .val { font-size: 40px; }
            
            /* Ajuste Textos */
            h1 { font-size: 28px !important; }
            .patient-card-glow { padding: 15px; }
            .patient-card-glow h2 { font-size: 24px !important; }
        }
    </style>
...
def mostrar_pantalla_login():
    ...
    st.markdown("""<style>
        ...
        @media (max-width: 768px) {
            div.block-container { margin-top: 2vh !important; width: 90% !important; padding: 30px 20px !important; }
        }
        .enterprise-title { color: #0B2B22; font-family: 'Cinzel', serif; font-size: 32px; font-weight: 700; margin-top: 15px; margin-bottom: 2px; text-align: center; } 
        .enterprise-subtitle { color: #A38025; font-size: 11px; font-weight: 600; margin-bottom: 35px; text-transform: uppercase; letter-spacing: 2px; text-align: center; } 
        div.stButton > button { background: linear-gradient(135deg, #0B2B22 0%, #123C30 100%) !important; color: #FFFFFF !important; border: 1px solid #D4AF37 !important; padding: 14px 0 !important; border-radius: 12px !important; width: 100% !important; display: block !important; margin: 0 auto !important; font-weight: 600 !important; } 
